...
export const themeInitScript = `(function(){try{var d=document.documentElement;if(/MVMarketsApp/.test(navigator.userAgent))d.classList.add('in-app');if(location.pathname.indexOf('/admin')===0){d.dataset.theme='light';return}var t=localStorage.getItem('${THEME_KEY}');if(t!=='light'&&t!=='dark')t=matchMedia('(prefers-color-scheme: dark)').matches?'dark':'light';d.dataset.theme=t}catch(e){}})();window.addEventListener('beforeinstallprompt',function(e){e.preventDefault();window.__mvmInstall=e;window.dispatchEvent(new Event('mvm-install-ready'))});`;
